  ...
  theme: {
    extend: {
      colors: {
        brand: {
          DEFAULT:
            "color-mix(in srgb, var(--color-brand-primary) calc(<alpha-value> * 100%), transparent)",
          primary:
            "color-mix(in srgb, var(--color-brand-primary) calc(<alpha-value> * 100%), transparent)",
          "primary-hover":
            "color-mix(in srgb, var(--color-brand-primary-hover) calc(<alpha-value> * 100%), transparent)",
          "on-primary":
            "color-mix(in srgb, var(--color-brand-on-primary) calc(<alpha-value> * 100%), transparent)",
          secondary:
            "color-mix(in srgb, var(--color-brand-secondary) calc(<alpha-value> * 100%), transparent)",
          tint: "color-mix(in srgb, var(--color-brand-tint) calc(<alpha-value> * 100%), transparent)",
          "on-tint":
            "color-mix(in srgb, var(--color-brand-on-tint) calc(<alpha-value> * 100%), transparent)",
        },
        background:
        ...
        "surface-2":
          "color-mix(in srgb, var(--color-surface-2) calc(<alpha-value> * 100%), transparent)",
        border: "color-mix(in srgb, var(--color-border) calc(<alpha-value> * 100%), transparent)",
        "border-hover":
          "color-mix(in srgb, var(--color-border-hover) calc(<alpha-value> * 100%), transparent)",
        ...
        "border-control":
          "color-mix(in srgb, var(--color-border-control) calc(<alpha-value> * 100%), transparent)",
        "border-control-hover":
          "color-mix(in srgb, var(--color-border-control-hover) calc(<alpha-value> * 100%), transparent)",
        "text-primary":
        ...
        "text-muted":
          "color-mix(in srgb, var(--color-text-muted) calc(<alpha-value> * 100%), transparent)",
        "text-emphasis":
          "color-mix(in srgb, var(--color-text-emphasis) calc(<alpha-value> * 100%), transparent)",
        ...
        "on-error":
          "color-mix(in srgb, var(--color-on-error) calc(<alpha-value> * 100%), transparent)",
        info: "color-mix(in srgb, var(--color-info) calc(<alpha-value> * 100%), transparent)",
        modified:
          "color-mix(in srgb, var(--color-modified) calc(<alpha-value> * 100%), transparent)",
