...
**Date:** 2026-09-10 · **Status:** **SHIPPED — stamped 2026-09-20**, which the §2 table in this same file marks in every row. On `main`: HL1 (#354), HL2 (#364), HL3 (#371), HL4 (#377), HL5a (#399), HL5b (#390), HL5c (#425), HL5d (#401), HL5e (#432), HL5f (#428). **Superseded in part (2026-09-24):** HL-D1's element model was amended by **D158** (`2026-09-21_asset-model-authoring-and-rendering.md`). AR2 (#555) retired `elements` and `HtmlElementsEditor`, AR7 (#558) retired the `html` layer kind, and copy is now a `static-text` layer compiled to markup. What this plan shipped is history, not the current model.
