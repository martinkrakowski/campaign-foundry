...
Ownership is exclusive **among lanes running in the same wave**.
...
| **RW-25**                                  | Also open, also unscheduled: **D34**'s copy axes (vibes/directions/subline, never planned), **D51** per-creative finishing, **TS-Q1**, and **seat-selection S1–S4**.                                                                              |
