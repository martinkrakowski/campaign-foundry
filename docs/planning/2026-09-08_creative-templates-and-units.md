...
**Waves.** **L12** → **L1** → **L2** → **L3 ‖ L7** → **L4 ‖ L6** → **L5 ‖ L8** → **L9** → **H2** →
**L10** → **L11**.
...
- **L1**: every sample brief parses unedited **and comes back with the type's default template
  materialised** (D120); an unknown unit / creative type / layer kind is a 400 on `briefs`,
