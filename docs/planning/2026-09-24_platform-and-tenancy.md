...
**Date:** 2026-09-24 · **Status:** **r2 — D167 and D173 STAMPED (owner, 2026-09-24); Phase 0 in progress: **PT-0a done** — [#569](https://github.com/martinkrakowski/campaign-foundry/pull/569) (`b3322320`), [#570](https://github.com/martinkrakowski/campaign-foundry/pull/570) (`a48fcc9d`), [#571](https://github.com/martinkrakowski/campaign-foundry/pull/571) (`ca7a9520`). **PT-0b1 done** — [#572](https://github.com/martinkrakowski/campaign-foundry/pull/572) (`2f64f8fb`), [#573](https://github.com/martinkrakowski/campaign-foundry/pull/573) (`f9234f99`). **PT-0c done** — [#574](https://github.com/martinkrakowski/campaign-foundry/pull/574) (`27ed7d52`). **PT-0b2 done** — [#575](https://github.com/martinkrakowski/campaign-foundry/pull/575) (`bfbac87f`), [#576](https://github.com/martinkrakowski/campaign-foundry/pull/576) (`1df9fdbe`); **DoD 1 met.** **PT-0d done** — [#577](https://github.com/martinkrakowski/campaign-foundry/pull/577) (`df975038`), [#578](https://github.com/martinkrakowski/campaign-foundry/pull/578) (`0ff44ae9`); `cf:decisions` retired (DoD 4 still waits on PT-5's keys). **Phase 0 closed except PT-0e (owner's instruction).** Next lanes are blocked on D166 and D174 (PT-1 onward) and D175.** D166, D168 – D172, D174 and D175 remain proposed.
