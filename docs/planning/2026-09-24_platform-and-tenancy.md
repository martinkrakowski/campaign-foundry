...
- **Phase 2:** PT-4 (needs D174c), PT-5, PT-6 (needs D174d) and PT-7 follow PT-3; PT-7b follows PT-2 and D176.
...
- **Still open:** **D174b** (the auth vendor; blocks PT-1), **D174c** (the object store; blocks PT-4),
  **D174d** (the queue; blocks PT-6), and **D176** (where the key-encryption key lives; blocks PT-7b).
