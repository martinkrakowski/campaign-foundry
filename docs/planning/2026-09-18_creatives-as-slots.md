...
**Date:** 2026-09-18
**Status:** **decisions proposed, not stamped. Not dispatchable until SL-D2 is answered by the owner.**
...
| **SL-D8** | **The rename waits for the demotion.** The owner asked for a more descriptive name; renaming a global packing constraint while still applying it to pinned rows would be a lie. Rename once SL-D7 is real, and name it for what it then is (candidate: `spread`).                                                                                                                                                                                                                                                                                                                         | **proposed**                      |
...
| **SL5** | `VariationPolicy.vo.ts`, `messages.ts`, the editor                 | SL-D7 real | **SL-D8's rename.** Last, deliberately.                                                                                                                                        |
...
- **It is not dispatchable as a whole** — SL-D2 is open. **SL0 is dispatchable now** and is the one lane the owner already asked for twice.
