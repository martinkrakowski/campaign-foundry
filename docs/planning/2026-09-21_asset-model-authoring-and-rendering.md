...
**Status:** **CLOSED except AR6 — all six decisions stamped (D161 after the fact, 2026-09-24).** AR1 (#554), AR2 (#555), AR3 (#556), AR4 (#557) and AR7 (#558) merged; AR5 was closed by #555. The DoD gaps a 2026-09-23 verification found — the doubled headline, the html profile never packaged end to end, the retired kind refused without its fix, the click-target control on every kind — were closed by `2026-09-23_asset-model-follow-up.md`: AF1 (#562), AF2 (#563), AF3 (#559), AF4 (#564), AF5 (#560), AF6. **AR6 (`<video>` in the bundle) stays blocked on D64.** **Third draft**, revised the same day on the owner's corrections: D160 no longer mints a
